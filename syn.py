...
def makeIPHeader(sourceIP,destIP):
    ...
    return pack('!BBHHHBBH4s4s', ihlVersion, typeOfService, totalLength, id ,flagsOffSet, ttl, protocol, headerChecksum, sourceAddress, destinationAddress)
...
def makeTCPHeader(port, icheckSum="none"):
    ...
    return pack('!HHLLBBHHH', sourcePort, destinationAddressPort, SeqNumber, AckNumber, dataOffsetResv, flags, window, checksum, urgentPointer)
